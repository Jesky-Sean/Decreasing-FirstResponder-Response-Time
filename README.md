...
>*This Repo contains a README.md file with a proposal of its use and contains various images of my work along the way, in addition, it also contains My Drafted-pre-released white paper of this system and its use. in this paper it explains this system and ita purpose - and in summary, it's job is to create a *temporary dynamic express lane for first responders*, which, when activated; the systems main goal would be to help redirect and re-organize traffic within their respective lanes - this system is activated during an emergency response from first responders with *the goal to save 10,000 lives/yr [with a one minute reduction in response times], to a staggering and mind blowing 45,000 lives/yr [estimated with a three minute reduction in response times]* when implemented (in just america!!) with little or no effort from us, the citizens.
